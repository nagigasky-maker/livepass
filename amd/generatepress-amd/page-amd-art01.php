<?php
/**
 * ZINE ART.01 — MOZYSKEY × NOBBY
 * Template: page-zine-art01.php
 * Slug: zine-art01
 */
?>
<!DOCTYPE html>
...
<title>ZINE ART.01 — MOZYSKEY × NOBBY | ALL MUST DANCE™</title>
...
html { height:100%; }
body { overflow-x:hidden; overflow-y:auto; min-height:100vh; min-height:-webkit-fill-available; background:var(--black); color:var(--white); font-family:"Noto Sans JP","Montserrat",sans-serif; font-weight:300; font-feature-settings:"palt"; -webkit-font-smoothing:antialiased; -moz-osx-font-smoothing:grayscale; }
...
<div class="zine-hero">
  <img src="https://allmustdance.com/wp-content/uploads/2026/04/mozyskeyxnobby%E3%81%AE%E3%82%B3%E3%83%94%E3%83%BC.jpg" alt="MOZYSKEY × NOBBY">
  <div class="zine-hero-vig"></div>
  <div class="zine-hero-body">
    <div class="zine-hero-ep">ART.01</div>
    <div class="zine-hero-title">MOZYSKEY<br>× NOBBY</div>
    <div class="zine-hero-meta">Artist · Figure · Space Cooking™ · 2025</div>
  </div>
</div>

<div class="zine-article zine-body">
  <div class="zine-section-label">ABOUT</div>
  <p class="zine-lead">アーティストMOZYSKEYとNOBBYのコラボレーション。ダンスとアートが交差する、AMD™初のアートワークシリーズ。</p>
  ...
  <div class="zine-credit-block">
    <div class="zine-credit-row"><span>Artist</span><span>MOZYSKEY</span></div>
    <div class="zine-credit-row"><span>Photo</span><span>NOBBY</span></div>
