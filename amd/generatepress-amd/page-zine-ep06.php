<?php
/**
 * ZINE EP.06 — CHEEKY SESSION
 * Template: page-amd-ep06.php
 * Slug: zine-ep06
 */
?>
<!DOCTYPE html>
...
<title>ZINE EP.06 — CHEEKY SESSION | ALL MUST DANCE™</title>
...
<div class="zine-hero">
  <img src="https://allmustdance.com/wp-content/uploads/2026/01/009.jpeg" alt="CHEEKY SESSION">
  <div class="zine-hero-vig"></div>
  <div class="zine-hero-body">
    <div class="zine-hero-ep">EP.06</div>
    <div class="zine-hero-title">CHEEKY<br>SESSION</div>
    <div class="zine-hero-meta">Experimental · 2025 · ALL MUST DANCE™</div>
  </div>
</div>

<div class="zine-article zine-body">
  <div class="zine-section-label">ABOUT</div>
  <p class="zine-lead">実験的な一夜。Cheekyを舞台に、AMD™が新たな領域に踏み込んだセッション。</p>
...
<div class="zine-footer-nav">
  <a href="<?= home_url('/zine-ep07/') ?>">← EP.07</a>
