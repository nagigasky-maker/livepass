...
<title>ZINE EP.02 — WARSAW | ALL MUST DANCE™</title>
...
<!-- Hero cover -->
<div class="zine-hero">
  <img src="https://allmustdance.com/wp-content/uploads/2026/01/IMG_6299-scaled-e1769346293771.jpeg" alt="WARSAW">
  <div class="zine-hero-vig"></div>
  <div class="zine-hero-body">
    <div class="zine-hero-ep">EP.02</div>
    <div class="zine-hero-title">WARSAW</div>
    <div class="zine-hero-meta">Tour · Europe · 2023 · ALL MUST DANCE™</div>
  </div>
</div>
...
<div class="zine-article zine-body">
  ...
  <p class="zine-lead">ヨーロッパツアー。ワルシャワの地で、AMD™の精神が国境を越えた最初の記録。</p>
...
<div class="zine-footer-nav">
  ...
  <a href="<?= home_url('/zine-art01/') ?>">ART.01 →</a>
</div>
