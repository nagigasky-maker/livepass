...
<div class="amd-ticket-overlay" id="goodsOverlay">
  ...
  <div style="flex-shrink:0;position:relative;background:var(--black);">
    <div style="padding:0 20px 12px;display:flex;align-items:flex-end;justify-content:space-between;">
      <img src="<?= get_stylesheet_directory_uri() ?>/logos/gg.png" alt="GOOD GOODS" style="max-height:36px;margin-top:0;">
      <a href="https://zzazz-za.stores.jp/" target="_blank" class="a-subtle" style="font-size:11px;">Store All →</a>
    </div>
    <div style="width:100%;"><img src="<?= get_stylesheet_directory_uri() ?>/artwear/zzazzcm.GIF" alt="ZZAZZ" loading="lazy" style="width:100%;display:block;"></div>
  </div>
  <div style="flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch;overscroll-behavior-y:contain;">
