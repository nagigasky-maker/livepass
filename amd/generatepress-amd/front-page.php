...
#p1-1 .eyebrow, #p1-1 .af-genre, #p1-1 .af-name, #p1-1 .af-desc, #p1-1 .af-desc-en { margin-left:29px !important; margin-right:29px !important; }
...
.amd-card-content { position:absolute; top:0; bottom:0; left:29px; right:29px; z-index:2; display:flex; flex-direction:column; justify-content:flex-end; padding-bottom:44px; box-sizing:border-box; }
